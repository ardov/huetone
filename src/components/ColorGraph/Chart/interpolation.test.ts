...
test('paddedScale', () => {
  expect(paddedScale([0, 100])(0.5)).toBe(50)
  expect(paddedScale([0, 100])(0)).toBe(0)
  expect(paddedScale([0, 100])(0.2)).toBe(0)
  expect(paddedScale([0, 100])(1)).toBe(100)
  expect(paddedScale([10, 999], 1000)(0.4)).toBeLessThan(10)
})
